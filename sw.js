const CACHE="bruno-set-tools-media-v1.3";
const ASSETS=["./","./index.html","./style.css?v=1.3","./app.js?v=1.3","./manifest.webmanifest","./icon-192.png","./icon-512.png","./logo-bruno-guillard.png"];
