const CACHE="bos-media-v2.14";
const ASSETS=["./","./index.html","./style.css?v=2.14","./app.js?v=2.14","./manifest.webmanifest","./icon-192.png","./icon-512.png","./logo-bruno-guillard.png","./assets/logo-bos-header.jpg"];
