const CACHE="bos-media-v2.10";
const ASSETS=["./","./index.html","./style.css?v=2.10","./app.js?v=2.10","./manifest.webmanifest","./icon-192.png","./icon-512.png","./logo-bruno-guillard.png","./assets/logo-bos-header.jpg"];
