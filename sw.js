const CACHE="bruno-set-tools-media-v1.8";
const ASSETS=["./","./index.html","./style.css?v=1.8","./app.js?v=1.8","./manifest.webmanifest","./icon-192.png","./icon-512.png","./logo-bruno-guillard.png"];
