const CACHE="bruno-onset-media-v2.4";
const ASSETS=["./","./index.html","./style.css?v=2.4","./app.js?v=2.4","./manifest.webmanifest","./icon-192.png","./icon-512.png","./logo-bruno-guillard.png"];
