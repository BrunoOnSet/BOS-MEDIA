const CACHE="bruno-onset-media-v2.3";
const ASSETS=["./","./index.html","./style.css?v=2.3","./app.js?v=2.3","./manifest.webmanifest","./icon-192.png","./icon-512.png","./logo-bruno-guillard.png"];
