const CACHE="bruno-set-tools-media-v2.2";
const ASSETS=["./","./index.html","./style.css?v=2.2","./app.js?v=2.2","./manifest.webmanifest","./icon-192.png","./icon-512.png","./logo-bruno-guillard.png"];
